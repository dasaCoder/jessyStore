...
<div class="page-head_agile_info_w3l">
  ...
  <!-- banner-bootom-w3-agileits -->
	...
	<div class="container">
		...
		<div class="col-md-8 col-md-offset-1 products-right">
			...
			<div class="men-wear-top">
				...
				<div  id="top" class="callbacks_container">
					<ul class="rslides" id="slider3">
						<li>
							<img class="img-responsive" src="../image/960.jpg" alt=" "/>
						</li>
						<li>
							<img class="img-responsive" src="../image/pit.png" alt=" "/>
						</li>
						<li>
							<img class="img-responsive" src="../image/lab.jpg" alt=" "/>
						</li>
		...
		<div id="category_div" class="single-pro">
			...
			<div class="sign-grds">
				<div class="col-md-4 sign-gd">
					...
					<ul>
						...
						<li><a href="category.php">Men's Wear</a></li>
